...
broker = '192.168.100.102'  # mqtt代理服务器地址
port = 1883
...
def loadfile():
    ...
    config_file_path = os.path.join(os.path.abspath(os.path.dirname(current_path) + os.path.sep + "."), 'localfile')
    print('当前目录:' + current_path)
    print('当前父目录:' + father_path)
    print('localfile路径:' + config_file_path)
